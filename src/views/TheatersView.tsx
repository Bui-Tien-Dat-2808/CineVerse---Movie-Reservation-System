    ...
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-8 pb-20 space-y-12">
              ...
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <h3 className={cn('font-display font-extrabold text-lg group-hover:text-[#e8b84b] transition-colors', isDark ? 'text-[#f0ede8]' : 'text-slate-900')}>
                      📍 {cinema.name}
                    </h3>
      ...
      <section id="showtime-schedule" aria-label="Lịch chiếu phim" className="space-y-6 pt-4">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-white/10">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <span className={cn('text-[11px] font-mono-data font-bold px-3 py-1 rounded-xl border', isDark ? 'bg-amber-500/15 border-amber-500/30 text-amber-400' : 'bg-amber-100 border-amber-300 text-amber-950')}>
                🎥 IMAX 3D Laser
              </span>
              <span className={cn('text-[11px] font-mono-data font-bold px-3 py-1 rounded-xl border', isDark ? 'bg-blue-500/15 border-blue-500/30 text-blue-400' : 'bg-blue-100 border-blue-300 text-blue-950')}>
                ⚡ 4DX Motion
              </span>
              <span className={cn('text-[11px] font-mono-data font-bold px-3 py-1 rounded-xl border', isDark ? 'bg-purple-500/15 border-purple-500/30 text-purple-400' : 'bg-purple-100 border-purple-300 text-purple-950')}>
                👑 VIP Gold Lounge
              </span>
              <span className={cn('text-[11px] font-mono-data font-bold px-3 py-1 rounded-xl border', isDark ? 'bg-emerald-500/15 border-emerald-500/30 text-emerald-300' : 'bg-emerald-100 border-emerald-300 text-emerald-950')}>
                🔊 Dolby Atmos
              </span>
            </div>
          </div>
          ...
          <div className="pt-5">
            <label className={cn('text-xs font-mono-data font-bold uppercase tracking-wider block mb-3', isDark ? 'text-[#a09e9a]' : 'text-slate-700')}>
              📅 Chọn ngày chiếu:
            </label>
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap mb-1">
                        ...
                        {movie.duration_minutes && (
                          <span className={cn('text-xs font-mono-data', isDark ? 'text-[#a09e9a]' : 'text-slate-600 font-medium')}>
                            ⏱️ {movie.duration_minutes} phút
                          </span>
                        )}
                      </div>
      ...
      <section aria-label="Các Công Nghệ Rạp Nổi Bật" className="pt-6">
        <h2 className={cn('font-display font-extrabold text-2xl mb-6 flex items-center gap-2', isDark ? 'text-[#f0ede8]' : 'text-slate-900')}>
          <span>📽️</span> Các Công Nghệ Rạp Nổi Bật Tại CineVerse
        </h2>
